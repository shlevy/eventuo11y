{ system
  ...
  ({
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "bifunctors"; version = "5.5.14"; };
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "http://hackage.haskell.org/package/bifunctors-5.5.14.tar.gz";
      sha256 = "530116d0c47cde3b76c3b9b7d11f0599196739033f973317e876776334699264";
      });
    }) // {
