{ system
  ...
  ({
    ...
    package = {
      specVersion = "1.10";
      identifier = { name = "http2"; version = "4.0.0"; };
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchurl {
      url = "http://hackage.haskell.org/package/http2-4.0.0.tar.gz";
      sha256 = "eb9b7f0690aec4839792544fc3ccc4f6f141fe3f4f2952a19c3abed3e70479bf";
      });
    }) // {
